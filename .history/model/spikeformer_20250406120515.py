...
class SpikeDrivenTransformer(nn.Module):
    def __init__(
        ...
        if spike_mode in ["lif", "alif", "blif"]:
            ...
            self.head_lif = MultiStepIFNode(v_threshold=0.8, v_reset=v_reset, detach_reset=True, backend="cupy"), backend="cupy")
        elif spike_mode == "if_soft":
            self.head_lif = MultiStepIFNode(v_reset=None, detach_reset=True, backend="cupy")
        self.head = (
