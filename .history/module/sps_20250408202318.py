...
class MS_SPS(nn.Module):
    def __init__(
        ...
        if spike_mode == "if":
          ...
          self.proj_lif = MultiStepIFNode(v_threshold=1.1 , v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          ...
          self.proj_lif1 = MultiStepIFNode(v_threshold=1.1 , v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          ...
          self.proj_lif2 = MultiStepIFNode(v_threshold=1.1 , v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          ...
          self.proj_lif3 = MultiStepIFNode(v_threshold=1.1 , v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          ...
          self.rpe_lif = MultiStepIFNode(v_threshold=1.1 , v_reset=None, detach_reset=True, backend="cupy")
