...
class MS_SPS(nn.Module):
    def __init__(
        ...
        if spike_mode == "lif":
            ...
            self.proj_lif = MultiStepLearnableIFNode(init_threshold=0.8, v_reset=None, detach_reset=True)
        ...
        if spike_mode == "lif":
            ...
            self.proj_lif1 = MultiStepLearnableIFNode(init_threshold=0.8, v_reset=None, detach_reset=True)
        ...
        if spike_mode == "lif":
            ...
            self.proj_lif2 = MultiStepLearnableIFNode(init_threshold=0.8, v_reset=None, detach_reset=True)
        ...
        if spike_mode == "lif":
            ...
            self.proj_lif3 = MultiStepLearnableIFNode(init_threshold=0.8, v_reset=None, detach_reset=True)
        ...
        if spike_mode == "lif":
            ...
            self.rpe_lif = MultiStepLearnableIFNode(init_threshold=0.8, v_reset=None, detach_reset=True)
