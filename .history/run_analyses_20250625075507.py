...
def load_your_models():
    ...
    model_configs = {
        'LIF': {
            'checkpoint': 'Trained/Origin/Ori_b64/model_best.pth.tar',
            'spike_mode': 'lif'
        },
        'IF_Hard': {
            'checkpoint': 'Trained/IF_hard/b64_Uth1_2/model_best.pth.tar', 
            'spike_mode': 'if'
        },
        'IF_Soft': {
            'checkpoint': 'Trained/IF_soft/b64_Uth1.2/model_best.pth.tar',
            'spike_mode': 'if_soft'
        }
    }
