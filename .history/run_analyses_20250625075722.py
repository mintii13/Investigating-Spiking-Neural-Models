...
from spikeformer import sdt  # Import your model
...
def load_your_models():
    ...
    model_configs = {
        'LIF': {
            'checkpoint': 'checkpoints/lif_model_best.pth',  # Update path này
            'config': {
                'img_size_h': 32,
                'img_size_w': 32,
                'patch_size': 4,
        ...
        'IF_Hard': {
            'checkpoint': 'checkpoints/if_hard_model_best.pth',  # Update path này
            'config': {
                'img_size_h': 32,
                'img_size_w': 32,
                'patch_size': 4,
        ...
        'IF_Soft': {
            'checkpoint': 'checkpoints/if_soft_model_best.pth',  # Update path này
            'config': {
                'img_size_h': 32,
                'img_size_w': 32,
                'patch_size': 4,
