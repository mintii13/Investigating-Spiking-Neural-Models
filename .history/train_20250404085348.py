...
parser.add_argument(
    "--resume",
    default="./output/train\\20250330-150105-sdt-data-cifar10-t-50-spike-lif\\checkpoint-10.pth.tar",
    type=str,
    metavar="PATH",
...
def train_one_epoch(
    ...
    time_interval = args.time_steps  # Số bước thời gian cho mã hóa
