...
parser.add_argument(
    "--resume",
    default="D:\FPTU-sourse\Term4\ResFes\Spike-Driven-Transformer_newSPS\output\train\20250626-095928-sdt-data-cifar10-t-4-spike-if_soft-rpe-linear\last.pth.tar",
    type=str,
    metavar="PATH",
