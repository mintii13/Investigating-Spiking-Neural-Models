...
class MS_SPS(nn.Module):
    def __init__(
        ...
        if spike_mode == "if":
          ...
          self.proj_lif = MultiStepIFNode(v_reset=v_reset, detach_reset=True, backend="cupy")
        elif spike_mode == "if_soft":
          print("spike_mode = if_soft")
          self.proj_lif = MultiStepIFNode(v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          self.proj_lif1 = MultiStepIFNode(v_reset=v_reset, detach_reset=True, backend="cupy")
        elif spike_mode == "if_soft":
          self.proj_lif1 = MultiStepIFNode(v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          self.proj_lif2 = MultiStepIFNode(v_reset=v_reset, detach_reset=True, backend="cupy")
        elif spike_mode == "if_soft":
          self.proj_lif2 = MultiStepIFNode(v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          self.proj_lif3 = MultiStepIFNode(v_reset=v_reset, detach_reset=True, backend="cupy")
        elif spike_mode == "if_soft":
          self.proj_lif3 = MultiStepIFNode(v_reset=None, detach_reset=True, backend="cupy")
        ...
        if spike_mode == "if":
          self.rpe_lif = MultiStepIFNode(v_reset=v_reset, detach_reset=True, backend="cupy")
        elif spike_mode == "if_soft":
          self.rpe_lif = MultiStepIFNode(v_reset=None, detach_reset=True, backend="cupy")
