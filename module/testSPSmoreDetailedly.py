...
class MS_SPS(nn.Module):
    ...
    def forward(self, x, hook=None):
        ...
        print_spike_count("After proj_lif1 (LIF Neuron)", x)
        ...
        print_spike_count("After proj_lif2 (LIF Neuron)", x)
        ...
        print_spike_count("After proj_lif3 (LIF Neuron)", x)
        ...
        print_spike_count("After rpe_lif (LIF Neuron)", x)
