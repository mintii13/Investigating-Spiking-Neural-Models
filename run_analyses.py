...
def load_your_models():
    ...
    model_configs = {
        'LIF': {
            'checkpoint': 'Trained/Origin/Ori_b64/model_best.pth.tar',  # Update path này
            'config': {
                'img_size_h': 32,
                'img_size_w': 32,
                'patch_size': 4,
        ...
        'IF_Hard': {
            'checkpoint': 'Trained/IF_hard/b64_Uth1_2/model_best.pth.tar',  # Update path này
            'config': {
                'img_size_h': 32,
                'img_size_w': 32,
                'patch_size': 4,
        ...
        'IF_Soft': {
            'checkpoint': 'Trained/IF_soft/b64_Uth1.2/model_best.pth.tar',  # Update path này
            'config': {
                'img_size_h': 32,
                'img_size_w': 32,
                'patch_size': 4,
